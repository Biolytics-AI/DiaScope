...
<CardGrid stagger>
	...
	<Card title="Claude Code + Codex" icon="bot">
...
If you want the shortest path, start with [Getting Started](/getting-started/). If you want to work through Claude Code or Codex, open [AI Agents](/guides/ai-agents/). If you want to see a realistic example first, open [Compliant GPU Blueprint](/examples/vllm-deployment/).
